...
Guidance for AI coding agents working on the Varbase AI Editor Assistant recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_ai_editor_assistant](https://git.drupalcode.org/project/varbase_ai_editor_assistant/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_ai_editor_assistant](https://www.drupal.org/project/issues/varbase_ai_editor_assistant)
